export default {
    ...
    'VIEW_TICKET': 'Ticketcheck',
    'VIEW_TICKET_DESCRIPTION': 'Überprüfen Sie den Status Ihres Tickets.',
    ...
    'NOREPLY_EMAIL': 'Keine Antwort E-Mailadresse',
    'SMTP_USER': 'SMTP-Benutzer',
    'SMTP_SERVER': 'SMTP-Server',
    'SMTP_PASSWORD': 'SMTP-Kennwort',
    'PORT': 'Port',
    'RECAPTCHA_PUBLIC_KEY': 'Websiteschlüssel Recaptcha',
    'RECAPTCHA_PRIVATE_KEY': 'Recaptcha Privaterschlüssel',
    ...
    //VIEW DESCRIPTIONS
    'CREATE_TICKET_DESCRIPTION': 'Dies ist das Formular für die Erstellung von Tickets. Füllen Sie das Formular aus und senden Sie uns Ihre Fragen, Probleme, Anregungen und Kritik. Unser Supportteam wird sich so schnell wie möglich bei Ihnen melden.',
    'TICKET_LIST_DESCRIPTION': 'Hier finden Sie eine Liste aller Tickets, die Sie an unser Support-Team gesendet haben.',
    'TICKETS_DESCRIPTION': 'Erstellen Sie eine neue Anfrage.',
    'ARTICLES_DESCRIPTION': 'Werfen Sie einen Blick in unsere Dokumentation und den meist gestellten Fragen.',
    ...
    'SUPPORT_CENTER_DESCRIPTION': 'Herzlich willkommen in unserem Supportcenter. Sie haben hier die Möglichkeit uns per Ticket eine Nachricht zukommen zu lassen oder zuschauen ob Ihre Frage schon in den Artikeln beantwortet wurde.',
    ...
    'LIST_ARTICLES_DESCRIPTION': 'Dies ist eine Liste von Artikeln, die Informationen rund um unsere Dienstleistungen enthalten und die meist gestellten Fragen beantworten.',
